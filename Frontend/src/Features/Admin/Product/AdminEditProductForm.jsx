...
export function AdminEditProductForm() {
  ...
  return (
    <div className="wrapper sm:mx-16 my-5 bg-white box-border p-4">
      <header className="font-bold text-4xl">Edit Product Form</header>

      {/* form */}
      {product && (
        <form className="mt-5" onSubmit={handleSubmit(editFormSubmitHandler)}>
          {/* Title */}
                            ...
                            <>
                              <div className="flex flex-col sm:flex-row gap-2 ">
                                ...
                                <div className="flex gap-4 items-center sm:flex-col ">
                                  ...
                                  />
                                  {errors?.variations?.[variationIndex]
                                    ?.colors?.[colorFieldIndex]?.colorCode && (
                                    <span className="text-red-500 text-sm">
                                      {
                                        errors.variations[variationIndex]
                                          .colors[colorFieldIndex].colorCode
